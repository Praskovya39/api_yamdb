...
class Command(BaseCommand):
    ...
    def import_user(self):
        ...
        for row in DictReader(open(CSV_DIR / 'users.csv', encoding='utf8')):
            User.objects.create(
                id=row['id'],
    ...
    def import_category(self):
        ...
        for row in DictReader(open(CSV_DIR / 'categoty.csv', encoding='utf8')):
    ...
    def import_genre(self):
        ...
        for row in DictReader(open(CSV_DIR / 'genre.csv', encoding='utf8')):
    ...
    def import_title(self):
        ...
        for row in DictReader(open(CSV_DIR / 'titles.csv', encoding='utf8')):
